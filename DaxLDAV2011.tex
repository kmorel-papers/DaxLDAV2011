...
streaming mechanism by automatically orchestrating task parallelism in
...
future, the exascale machine, we discover that this parallelism model will
...
Put simply, efficient parallelism on exascale machines requires a massive
...
invoked.  Large scale parallelism today is achieved by replicating the
