...
\abstract{ Experts agree that the exascale machine will comprise processors
  ...
  degree of concurrency.  Software will require a minimum of a 1,000 times
  ...
  threads is too large to make effective use of all the cores in an
  extreme-scale machine.  This paper introduces a new visualization framework
...
\begin{figure}
  ...
  \caption{Comparison between traditional visualization pipeline execution
    and Dax pipeline execution. Dax makes it possible to achieve higher
